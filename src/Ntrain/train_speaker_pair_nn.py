...
BEST_ENCODER_PATH = os.path.join(ARTIFACT_DIR, "ecapa_finetuned_speakerid.pt")
BEST_CLASSIFIER_PATH = os.path.join(ARTIFACT_DIR, "speaker_classifier_head.pt")
SPEAKER_LABELS_PATH = os.path.join(ARTIFACT_DIR, "speaker_label_mapping.pt")
