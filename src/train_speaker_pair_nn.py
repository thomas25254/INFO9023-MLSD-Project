...
MODEL_DIR = os.path.join(_SRC_DIR, "Ntrain", "models")
LIBRI_ROOT = "train-clean-100/LibriSpeech/train-clean-100"

ARTIFACT_DIR = os.path.join(os.path.dirname(_SRC_DIR), "artifacts")
BEST_ENCODER_PATH = os.path.join(
    ARTIFACT_DIR, "ecapa_finetuned_speakerid_hidden512_Llr.pt"
)
BEST_CLASSIFIER_PATH = os.path.join(
    ARTIFACT_DIR, "speaker_classifier_head_hidden512_Llr.pt"
)
SPEAKER_LABELS_PATH = os.path.join(
    ARTIFACT_DIR, "speaker_label_mapping_hidden512_Llr.pt"
)
